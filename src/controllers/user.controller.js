...
const registerUser = asyncHandler(async (req, res) => {
    ...
    // Check for immage , check for avatar
    // Upload image to cloudinary, avatar check on cloudinary
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    // Validation - not empty, email format, password length
    // Check if user exists - email /&both username
    // Check if password is correct
    // Generate access token and refresh token
    // Save refresh token in db against user
    // Send Cookie, access token and user object in response
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(401, "Invalid or expired refresh token - login again");
    }
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    // Validation - not empty, password length
